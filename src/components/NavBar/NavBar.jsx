...
const NavBar = () => {
  ...
  <div className="navbar-start">
    <div  onClick={showHideBtn} className="dropdown">
      <div tabIndex={0} role="button" className="btn btn-ghost lg:hidden">
        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
      </div>
      <ul tabIndex={0} className={`${showHide? "hidden menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52" : "menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52"}`}>
      <li>
        <NavLink to="/" 
         className={({ isActive }) =>
         isActive
    ...
    <li>
    <a className="btn bg-[#59C6D2] text-white text-sm p-1 font-semibold">Sign Up</a>
  ...
  <div className="navbar-end gap-4 lg:flex hidden">
    <a className="btn bg-[#23BE0A] text-white text-base font-semibold">Sign In</a>
    <a className="btn bg-[#59C6D2] text-white text-base font-semibold">Sign Up</a>
  </div>
</div>
    );
};
